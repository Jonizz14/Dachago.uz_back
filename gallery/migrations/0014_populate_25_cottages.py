...
def populate_sample_data(apps, schema_editor):
    ...
    # Clear existing data to avoid duplicates during migration re-runs (though we shouldn't really delete prod data)
    # But since this is a dev/sample request, we do it.
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('gallery', '0013_remove_product_bedrooms_en_and_more'),
    ]

    operations = [
        migrations.RunPython(populate_sample_data, remove_sample_data),
    ]
